...
public class ContactsListViewHolderAdapter extends BaseAdapter {

    private Context context;
    private List<ContactListItem> data;

    public ContactsListViewHolderAdapter(Context context, List<ContactListItem> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ((TextView) convertView.findViewById(R.id.textItem1)).setText(((ContactListItem)getItem(position)).getUsername());
        ((CheckBox) convertView.findViewById(R.id.checkBox)).setActivated(((ContactListItem)getItem(position)).isChecked());

        viewHolder.textItem1.setText(((ContactListItem)getItem(position)).getUsername());
        viewHolder.checkBox.setActivated(((ContactListItem)getItem(position)).isChecked());
